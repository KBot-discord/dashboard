...
<svelte:head>
	<title>Terms of Service | KBot</title>
</svelte:head>
		...
		<div class="flex grow flex-col gap-4 lg:w-6/12">
			...
			<LegalSection title="1. Agreement to Terms">
				...
				<p>
					...
					changes or modifications to these Terms of Use from time to time .
			...
			<LegalSection title="15. Governing Law">
				<p>
					...
					Canada. KBot and yourself irrevocably consent that the courts of
