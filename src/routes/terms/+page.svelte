...
<main class="flex h-fit flex-col">
	<div class="flex grow flex-col lg:items-center p-7">
		<div class="flex grow flex-col gap-4 lg:w-6/12">
			<h1 class="text-4xl font-bold">
				<span>Terms of Use for KBot</span>
			</h1>
			<h2>Last updated: October 04, 2022</h2>
			<LegalSection title="1. Agreement to Terms">
				<p>
					{'These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and KBot ("Company", "we", "us", or "our"), concerning your access to and use of the'}
					<span class="text-[#FFFFFF] hover:text-[#60A5FA]">
					...
					by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms
					of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED
				...
				<p>
					...
					of Use, and you waive any right to receive specific notice of each such change. Please
			...
			<LegalSection title="3. User Representatives">
				<p>
			...
			<LegalSection title="4. User Registration">
				<p>
			...
			<LegalSection title="6. User Generated Contributions">
				<p>
			...
			<LegalSection title="7. Contribution License">
				<p>
			...
			<LegalSection title="8. Social Media">
				<p>
					...
					terms and conditions that govern your use of each Third-Party Account. You represent and
					...
					access to any Third-Party Accounts, you understand that (1) we may access, make available,
					...
					the Site via your account, including without limitation any friend lists and (2) we may
					...
					such Third Party Account is terminated by the third-party service provider, then Social
					Network Content may no longer be available on and through the Site. You will have the
					ability to disable the connection between your account on the Site and your Third-Party
			...
			<LegalSection title="9. Submissions">
				<p>
			...
			<LegalSection title="10. Third-Party Website and Content">
				<p>
			...
			<LegalSection title="11. Site Management">
				<p>
			...
			<LegalSection title="12. Privacy Policy">
				<p>
					...
					the Site from any other region of the world with laws or other requirements governing personal
					data collection, use, or disclosure that differ from applicable laws in the United States,
					then through your continued use of the Site, you are transferring your data to the United States,
					and you agree to have your data transferred to and processed in the United States. Further,
					we do not knowingly accept, request, or solicit information from children or knowingly market
					to children. Therefore, in accordance with the U.S. Children’s Online Privacy Protection Act,
			...
			<LegalSection title="14. Modifications and Interruptions">
				<p>
			...
			<LegalSection title="15. Governing Law">
				<p>
					These Terms shall be governed by and defined following the laws of Canada. KBot and
					yourself irrevocably consent that the courts of Canada shall have exclusive jurisdiction
					to resolve any dispute which may arise in connection with these terms.
				</p>
			</LegalSection>
			<LegalSection title="16. Corrections">
				<p>
			...
			<LegalSection title="18. Limitations of Liability">
				<p>
			...
			<LegalSection title="20. User Data">
				<p>
			...
			<LegalSection title="21. Electronic Communications, Transactions, and Signatures">
				<p>
			...
			<LegalSection title="22. California Users and Residents">
				<p>
			...
			<LegalSection title="23. Miscellaneous">
				<p>
			...
			<LegalSection title="24. Contact Us">
				<p>
					In order to resolve a complaint regarding the Site or to receive further information
					regarding use of the Site, please contact us at:
				</p>
				<p>
					<a class="text-[#FFFFFF] hover:text-[#60A5FA]" href="mailto: support@kbot.ca">
						support@kbot.ca
					</a>
					<br />
					<a class="text-[#FFFFFF] hover:text-[#60A5FA]" href="https://discord.gg/pvGPcSwc9y">
						Support server
					</a>
				</p>
			</LegalSection>
