...
<svelte:head>
	<title>Privacy Policy | KBot</title>
</svelte:head>
	...
	<div class="flex grow flex-col lg:items-center p-7">
		<div class="flex grow flex-col gap-4 lg:w-6/12">
			...
			<div class="flex flex-col gap-4">
				<p>
					This policy is effective as of May 20, 2022 and was last updated on
					October 04, 2022.
				</p>
				<p>
					Your privacy is important to us. It is KBot&#39;s policy to respect your
					...
					website, <a class="text-[#FFFFFF] hover:text-[#60A5FA]" href="/">https://kbot.ca</a> , and other sites we own and operate.
				</p>
			</div>
			<LegalSection title="Information from Discord">
				<p>
					...
					accessing our products and services. Information including, but not
					limited to:
				</p>
				...
				<LegalSubsection title="Log Data">
					<p>
						In the event that an error occurs with the bot, log data will be
						collected which may include your Discord information. This data is
						only stored for internal uses to troubleshoot issues.
					</p>
				</LegalSubsection>
			</LegalSection>
			<LegalSection title="Information from use of kbot.ca">
				...
				<LegalSubsection title={"Children's Privacy"}>
					<p>
						...
						information about children under 13. In the case we discover that a
			...
			<LegalSection title="Changes to This Policy">
				<p>
					The contents of this privacy policy may occasionally be updated. It is
					recommended to check this periodically in case of any changes. Any
					changes to this policy will be made known at the top of the page.
				</p>
			</LegalSection>
