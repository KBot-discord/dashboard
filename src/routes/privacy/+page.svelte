<script lang="ts">
	...
	import LegalSubsection from '$lib/components/LegalSubsection.svelte';
</script>
	...
	<div class="flex grow flex-col lg:items-center p-7">
		<div class="flex grow flex-col gap-4 lg:w-6/12">
			...
			<div class="flex flex-col gap-4">
				<p>This policy is effective as of May 20, 2022 and was last updated on October 04, 2022.</p>
				<p>
					Your privacy is important to us. It is KBot&#39;s policy to respect your privacy and
					...
					collect about you, including across our website, <a
						class="text-[#FFFFFF] hover:text-[#60A5FA]"
						href="/">https://kbot.ca</a
					> , and other sites we own and operate.
				</p>
			</div>
			<LegalSection title="Information from Discord">
				<p>
					Information we collect includes both information you knowingly and actively provide us
					when using or participating in any of our services, and any information automatically sent
					by your devices in the course of accessing our products and services. Information
					including, but not limited to:
				</p>
				<ol class="list-decimal pl-10">
					<li>
						Any information provided through the requested{' '}
						<a
							class="text-[#FFFFFF] hover:text-[#60A5FA]"
				...
				<LegalSubsection title="Log Data">
					<p>
						In the event that an error occurs with the bot, log data will be collected which may
						include your Discord information. This data is only stored for internal uses to
						troubleshoot issues.
					</p>
				</LegalSubsection>
			</LegalSection>
			<LegalSection title="Information from use of kbot.ca">
				<LegalSubsection title="Log Data">
					<p>
				...
				<LegalSubsection title={"Children's Privacy"}>
					<p>
						We do not aim any of our products or services directly at children under the age of 13,
						and we do not knowingly collect personal information about children under 13. In the
						case we discover that a child under 13 has provided us with personal information, we
				...
				<LegalSubsection title="Disclosure of Personal Information to Third Parties">
					<p>We may disclose personal information to:</p>
					<ul class="pl-4 list-disc">
						<li>a parent, subsidiary, or affiliates</li>
						<li>
						...
						<li>
							...
							information, products, services, or direct marketing to you third parties to collect
							and process data
						</li>
					</ul>
				</LegalSubsection>
				<LegalSubsection title="Use of Cookies">
					<p>
						{"Cookies contain data which is stored in your browser's memory, and holds authentication info for the site."}
					</p>
				</LegalSubsection>
			</LegalSection>
			<LegalSection title="Limits of Our Policy">
				<p>
			...
			<LegalSection title="Changes to This Policy">
				<p>
					The contents of this privacy policy may occasionally be updated. It is recommended to
					check this periodically in case of any changes. Any changes to this policy will be made
					known at the top of the page.
				</p>
			</LegalSection>
